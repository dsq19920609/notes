[地址](https://github.com/jamiebuilds/babel-handbook/blob/master/translations/zh-Hans/user-handbook.md)
...
完整的官方插件列表请见 [Babel 插件页面](https://www.babeljs.cn/docs/plugins)。.
